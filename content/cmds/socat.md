+++
title = "socat"
date = 2024-10-11T19:45:34+08:00
weight = 0
type = "docs"
description = ""
isCJKLanguage = true
...
https://manpages.ubuntu.com/manpages/noble/en/man1/socat.1.html
...
```
       ...
       --experimental
              ...
              me explicitely enabled using this option.
       ...
       -4     Use  IP  version  4 in case the addresses do not implicitly or explicitly specify a
              version. Since version 1.8.0 the default is no preference.
...
```
       ...
       SOCKETPAIR
              ...
              because everything written to it appeares immediately as  read  data.  The  default
...
```
       ...
       v4mapped[=0|1]
              ...
              requiring  IPv6  addresses,  this  resolves  IPv4  addresses to the approriate IPv6
       ...
       TLS1.2 Select  TLS  protocol  version  1.2.   When  this  option  is  not provided OpenSSL
              negotiates the mothod with its peer.
...
```
       ...
       socat --experimental -u \
              ...
              Receives messages (packets) from POSIX message queue and, for each messages,  forks
              a  sub  process  that  reads and processes the message. At most 3 sub processes are
